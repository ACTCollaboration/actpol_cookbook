...
\ea
Defining $\phi_{\bm{\ell}}$ such as:
\ba
\cos\phi_{\bm{\ell}}=\frac{\ell_{x}}{\ell} \ , \ \cos 2\phi_{\bm{\ell}} = \frac{\ell_{x}^{2}-\ell_{y}^{2} }{\ell^{2}} \ , \ \sin 2\phi_{\bm{\ell}} = \frac{2\ell_{x}\ell_{y}}{\ell^{2}}
\ea
this is equivalent to the spin formalism for polarisation data
\ba
...
We need to extend the mode coupling calculation presented in  \ref{subsec:PSbasis}, to polarisation data.  We start by computing the Fourier transform of the Stokes component
\ba
...
\ea
Following what we have done in \ref{subsec:PSbasis}, we can relate the estimated power spectrum to the unbiased power spectrum with a mode coupling matrix.
\ba
...
0 & 
0 &
\cos^{2} \Delta_{\ell,\ell'} & 
-2 \cos \Delta_{\ell,\ell'}  \sin \Delta_{\ell,\ell'} &
\sin^{2} \Delta_{\ell,\ell'}  &  
 \cr
0 & 
0 &
\cos \Delta_{\ell,\ell'}  \sin \Delta_{\ell,\ell'} & 
\cos^{2} \Delta_{\ell,\ell'}-\sin^{2} \Delta_{\ell,\ell'} & 
-\cos \Delta_{\ell,\ell'}  \sin \Delta_{\ell,\ell'} & 
\cr
0 & 
0 &
...
\end{pmatrix}
\ea
With  $\Delta_{\ell,\ell'}= 2(\phi_{\bm{\ell'}} - \phi_{\bm{\ell}})$:
